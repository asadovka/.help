            ...
            <div className={styles.container}>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <h3>in your project "myApp" folder would present "distribution" folder. This is your builded app</h3>
                    </li>

                    <li>
                        <h3>If you want to put this app in the production and share it with friends install <Link to='/ipfs' >ipfs</Link> and run:</h3>
